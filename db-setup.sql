...
CREATE TABLE IF NOT EXISTS warnings(ID INT PRIMARY KEY NOT NULL AUTO_INCREMENT, guild BIGINT NOT NULL, member BIGINT NOT NULL, warning TEXT NOT NULL, moderator BIGINT NOT NULL, time DATETIME);
